"""
Builds the WIR Generate Tools user manual as a .docx, via Word itself.
...
OUTPUT = os.path.join(ROOT, "WIR Generate Tools - User Manual.docx")
...
try:
    ...
    m.para("WIR Generate Tools", style="Title")
    m.para("User manual", size=13, colour=GREY)
    m.para("i125 / Ghaf Woods  -  Work Inspection Requests", size=10, colour=GREY)
    m.para()
    m.para(
        "WIR Generate Tools prepares, checks and generates Work Inspection Requests. It works "
